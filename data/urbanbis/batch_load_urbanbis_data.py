...
import datetime
import numpy as np
from load_urbanbis_data import export
import pdb

SCANNET_DIR = 'scans'
SCAN_NAMES = sorted([line.rstrip() for line in open('/mnt/d/our/data/urbanbis/meta_data/city_area_test.txt')])
...
MAX_NUM_POINT = 50000
OUTPUT_FOLDER = '/mnt/d/our/data/urbanbis/urbanbis_data/'

def batch_export():
    if not os.path.exists(OUTPUT_FOLDER):
        print('Creating new data folder: {}'.format(OUTPUT_FOLDER))                
        os.mkdir(OUTPUT_FOLDER)        
    main_path = "/mnt/Dataset/Test"
